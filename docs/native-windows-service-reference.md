> Historical service-based development reference. These instructions describe the earlier installer, not development.5. Use [the current Windows guide](native-windows.md) for the per-user Portal Agent.
